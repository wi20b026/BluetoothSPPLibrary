...
public class Main extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set zero button
        Button btnSetZero = (Button) findViewById(R.id.btnSetZero);
        btnTerminal.setOnClickListener(this);

        //start measurement button
        Button btnStartMeasurement = (Button) findViewById(R.id.btnStartMeasurement);
        btnTerminal.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.btnSetZero:
                intent = new Intent(getApplicationContext(), SetNullActivity.class);
                startActivity(intent);
                break;
            case R.id.btnStartMeasurement:
                intent = new Intent(getApplicationContext(), StartMeasurementActivity.class);
                startActivity(intent);
                break;
        }
    }
